...
#include "globals.h"
  ...
  #undef W5100_ETHERNET_SHIELD // Arduino Ethenret Shield and Compatibles ...
  #undef W5500_ETHERNET_SHIELD   // WIZ550io, ioShield series of WIZnet
#elif WIRED_ETHERNET_MODE == WIRED_ETHERNET_W5100
  #define W5100_ETHERNET_SHIELD // Arduino Ethenret Shield and Compatibles ...
  #undef W5500_ETHERNET_SHIELD   // WIZ550io, ioShield series of WIZnet
#elif WIRED_ETHERNET_MODE == WIRED_ETHERNET_W5500
  #undef W5100_ETHERNET_SHIELD // Arduino Ethenret Shield and Compatibles ...
  #define W5500_ETHERNET_SHIELD   // WIZ550io, ioShield series of WIZnet
#else
  #error Invalid wired ethernet mode 
#endif
...
#define SPI_CS ETHERNET_SPI_SS_PIN
...
/*#if defined(ARDUINO_ARCH_AVR)
  ...
  inline static void setSS()     { digitalWrite(SPI_CS, LOW); };
  inline static void resetSS()   { digitalWrite(SPI_CS, HIGH); };
/*#else
